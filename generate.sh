...
GENERATED="${GOPATH}/src/github.com/Swapica/rpc-proxy-svc/resources"
OPENAPI_DIR="${GOPATH}/src/github.com/Swapica/rpc-proxy-svc/docs/web_deploy"
...
function generate {
    ...
    echo "No need to generate Go API models. As soon as it's needed, modify the generate.sh to run the full generation."
